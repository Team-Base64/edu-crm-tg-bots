...
function main() {
    ...
    try{
      ...
      channel.watchConnectivityState(state, Infinity, () => {console.log("state!!", state)})
    ...
    } finally{setInterval(() => {console.log("state from setInt ", client.getChannel().getConnectivityState(false))}, 5000)}
